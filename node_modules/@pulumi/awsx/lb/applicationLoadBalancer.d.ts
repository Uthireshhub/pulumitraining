 ...
 */
export declare class ApplicationLoadBalancer extends pulumi.ComponentResource {
    /**
     * Returns true if the given object is an instance of ApplicationLoadBalancer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ApplicationLoadBalancer;
    /**
     * Default security group, if auto-created
     */
    readonly defaultSecurityGroup: pulumi.Output<pulumiAws.ec2.SecurityGroup | undefined>;
    /**
